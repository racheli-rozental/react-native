...
const EditCategoryModal = ({ visible, editedName, setEditedName, onSave, onClose, isDarkMode }) => {
  return (
    <Modal animationType="slide" transparent={true} visible={visible} onRequestClose={onClose}>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { backgroundColor: isDarkMode ? "#333" : "#fff" }]}>
          <Text style={[styles.modalTitle, { color: isDarkMode ? "#fff" : "#000" }]}>Edit Category</Text>
